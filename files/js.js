...
function changeStyle(theme) { const link = document.getElementById('theme-style'); if (theme === 'dark') { link.href = 'styles/dark-theme.css'; } else if (theme === 'light') { link.href = 'styles/light-theme.css'; } localStorage.setItem('currentTheme', theme); } window.onload = function() { const savedTheme = localStorage.getItem('currentTheme'); if (savedTheme) { changeStyle(savedTheme); } };
